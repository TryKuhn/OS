...
const char *latestFeatures[] = {
        ...
        "Implemented strict mode to validate test, use registerValidation() to switch it on",
...
public:
    Validator() : _initialized(false), _testset("test"), _group() {
    }
...
public:
    Checker() : _initialized(false), _testset("test"), _group() {
    }
 ...
 *
 * Algorithm details:
 * Please refer to the implementation to see how the code handles the 3rd and 4th forms separately.
 */
